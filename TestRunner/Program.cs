    ...
    internal class Program
    {
        ...
        static void BasicCloneTest()
        {
            ...
            pai.Children.Add(new()
            {
                ID = 7777,
                Name = "GHI...",
                Parent = new ObjetoTestePai() { ID = 987, Name = "ZZZ...", Options = new[] { new ObjetoTestePai() { ID = 654, Name = "RRR..." } } }
            });
            ...
            filho.Dependencies.Add(new ObjetoTestePai() { ID = 3535529, Name = "WRJQDRI..." });

            var copy = Cloner.Clone(pai);

            UnitTest.Assert(() => copy != null);
            UnitTest.Assert(() => copy.ID == 5555 && copy.Name == "ABC...");
            ...
            UnitTest.Assert(() => copy.Children[0].Parent.Options[0].ID == 654 && copy.Children[0].Parent.Options[0].Name == "RRR...");
            ...
            UnitTest.Assert(() => copy.Elements[0].Dependencies[0].ID == 3535529 && copy.Elements[0].Dependencies[0].Name == "WRJQDRI...");
        }
